...
use crate::keccak_permutation::columns::{reg_step, NUM_COLUMNS};
use crate::keccak_permutation::keccak_permutation_stark::NUM_ROUNDS;
...
pub(crate) fn eval_round_flags<F: Field, P: PackedField<Scalar = F>>(
    vars: StarkEvaluationVars<F, P, NUM_COLUMNS, 0>,
...
pub(crate) fn eval_round_flags_recursively<F: RichField + Extendable<D>, const D: usize>(
    ...
    vars: StarkEvaluationTargets<D, NUM_COLUMNS, 0>,
